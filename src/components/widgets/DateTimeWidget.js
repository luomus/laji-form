	...
	render() {
		...
		return showButtons ? (
			<div className="date-widget" ref={this.setContainerRef}>
				...
				<ButtonGroup>
					<Button variant="default" className="today" onClick={this.setToday} disabled={readonly || disabled}>{translations.Today}</Button>
					<Button variant="default" className="yesterday" onClick={this.setYesterday} disabled={readonly || disabled}>{translations.Yesterday}</Button>
				</ButtonGroup>
			</div>
